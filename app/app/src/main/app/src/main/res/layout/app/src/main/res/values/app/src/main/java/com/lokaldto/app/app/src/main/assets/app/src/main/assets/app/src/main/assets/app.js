const businesses = [
    {
        ...
        distance: "0.4 km",
        description: "Traditional Filipino kakanin and homemade snacks."
    },

    {
        ...
        location: "San Ildefonso, Bulacan",
        distance: "0.7 km",
        description: "A cozy neighborhood coffee shop featuring local drinks."
    },

    {
        ...
        distance: "1.2 km",
        description: "Local plants, pots and gardening supplies."
    },

    {
        ...
        distance: "1.5 km",
        description: "Affordable bicycle repair and maintenance."
    },

    {
        ...
        distance: "2.0 km",
        description: "A small local shop featuring everyday Filipino essentials."
    },

    {
        ...
        distance: "2.4 km",
        description: "Fresh baked goods and locally inspired coffee."
    },

    {
        ...
        location: "Plaridel, Bulacan",
        distance: "2.8 km",
        description: "Homemade Filipino meals and desserts."
    },

    {
        ...
        distance: "3.1 km",
        description: "Handcrafted local products and Filipino-inspired decor."
    },

    {
        ...
        distance: "3.7 km",
        description: "Basic gadget accessories and repair services."
    },

    {
        ...
        distance: "4.1 km",
        description: "Fresh produce and locally sourced products."
    }
];
...
function openSellerDashboard() {
    ...
    if (savedName) {
        document.getElementById("sellerName").value = savedName;
    }
...
function toggleSaved(id) {
    ...
    if (saved.includes(id)) {
        ...
        saved =
            saved.filter(storeId => storeId !== id);
...
function saveSeller() {
    ...
    alert("Your store information has been saved!");
          }
